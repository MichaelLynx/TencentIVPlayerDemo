...
+ (id)expandWithScrollView:(UIScrollView*)scrollView expandView:(UIView*)expandView heigth:(CGFloat)heigth{
    CExpandHeader *expandHeader = [CExpandHeader new];
    [expandHeader expandWithScrollView:scrollView expandView:expandView heigth:heigth];
    return expandHeader;
}
- (void)expandWithScrollView:(UIScrollView*)scrollView expandView:(UIView*)expandView heigth:(CGFloat)heigth{
    ...
    [_scrollView setContentOffset:CGPointMake(0, -heigth)];
