...
#pragma clang diagnostic pop
    ...
    if ([self.delegate respondsToSelector:@selector(xhLaunchAd:clickAndOpenModel:adType:clickPoint:)]) {
        [self.delegate xhLaunchAd:self clickAndOpenModel:configuration.openModel adType:configuration.opentype clickPoint:point];
        [self removeAndAnimateDefault];
    }
