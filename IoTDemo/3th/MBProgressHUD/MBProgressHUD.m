...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.detailsLabelFont = [UIFont boldSystemFontOfSize:kLabelFontSize];
		self.xOffset = 0.0f;
		self.yOffset = 0.0f;
...
- (void)layoutSubviews {
	...
	CGSize labelSize = MB_MULTILINE_TEXTSIZE(label.text, label.font,maxSize, detailsLabel.lineBreakMode);
