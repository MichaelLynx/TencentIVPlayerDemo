...
typedef NS_ENUM(NSInteger, BRDatePickerMode) {
    ...
    //时间制
   // 年月日时分
    BRDatePickerModeMDYHMA,        //  MM-dd-yyyy hh:mm a
    BRDatePickerModeMDYHM,         // MM-dd-yyyy HH:mm
    
    BRDatePickerModeYMDHMA      // yyyy-MM-dd HH:mm a

};

typedef void(^BRDateResultBlock)(NSString *selectValue,NSDate *selectedDate);
